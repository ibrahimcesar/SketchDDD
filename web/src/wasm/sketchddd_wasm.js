 ...
 * @returns {any}
 */
export function create_context(name) {
    const ptr0 = passStringToWasm0(name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.create_context(ptr0, len0);
    return ret;
}
 ...
 * @returns {any}
 */
export function generate_code(source, target) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(target, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.generate_code(ptr0, len0, ptr1, len1);
    return ret;
}
 ...
 * @returns {any}
 */
export function generate_viz(source, format) {
    const ptr0 = passStringToWasm0(source, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ptr1 = passStringToWasm0(format, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len1 = WASM_VECTOR_LEN;
    const ret = wasm.generate_viz(ptr0, len0, ptr1, len1);
    return ret;
}
 ...
 * @returns {any}
 */
export function supported_targets() {
    const ret = wasm.supported_targets();
    return ret;
}
 ...
 * @returns {any}
 */
export function supported_viz_formats() {
    const ret = wasm.supported_viz_formats();
    return ret;
}
 ...
 * @returns {any}
 */
export function validate(model_json) {
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('sketchddd_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
